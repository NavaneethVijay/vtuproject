...
df = pd.read_csv(r"Land_AT_WD.csv")
...
features = ["date", "meantempm", "meandewptm", "meanpressurem", "maxhumidity", "minhumidity", "maxtempm",  
            "mintempm", "maxdewptm", "mindewptm", "maxpressurem", "minpressurem", "precipm" ,"airtemperature","winddirection"]
...
to_remove = [feature  
             for feature in features 
             if feature not in ['meantempm', 'mintempm', 'maxtempm','airtemperature','winddirection']]
